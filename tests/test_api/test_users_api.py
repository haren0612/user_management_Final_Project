...
async def test_update_user_github(async_client, admin_user, admin_token):
    ...
    assert response.status_code == [status.HTTP_200_OK, status.HTTP_405_METHOD_NOT_ALLOWED, status.HTTP_422_UNPROCESSABLE_ENTITY]
...
async def test_create_user_github(async_client, admin_token):
    data = {
        ...
        "linkedin_profile_url": "https://linkedin.com/in/siddharthkundu",
        "github_profile_url": "https://github.com/sid995",
        "role": "ANONYMOUS",
        "password": "12345"
    }
